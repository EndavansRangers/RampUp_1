...
object Tunefy : BuildType({
    ...
    params {
        ...
        param("env.DOCKER_REGISTRY", "638325785916.dkr.ecr.us-east-1.amazonaws.com")
        param("env.AWS_DEFAULT_REGION", "us-east-1")
        param("env.OCTO_URL", "http://10.20.63.199:8080")
    ...
    steps {
        ...
        script {
            ...
            scriptContent = """
                ...
                # BACKEND_SERVICE_NAME: usar nombre corto con puerto (nginx lo resolverá al iniciar)
                # --no-cache: Forzar rebuild completo para aplicar nuevos build args
                docker build -t "${'$'}FRONT" \
                  ...
                  --build-arg BACKEND_SERVICE_NAME="backend:3001" \
