...
if kubectl get deployment -n cnpg-system cnpg-controller-manager &>/dev/null; then
    echo "CloudNativePG Operator ya está instalado"
...
echo ""
echo "GUARDA ESTAS CREDENCIALES - Las necesitarás para configurar el backend"
echo ""

# PASO 4: Crear PostgreSQL Cluster
echo "PASO 4: Creando PostgreSQL Cluster..."
echo ""
